...
and __ocaml_lex_token_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 26 "src/dune_lang/jbuild_lexer.mll"
    ( Lexing.new_line lexbuf; token lexbuf )
# 191 "src/dune_lang/jbuild_lexer.ml"

  | 1 ->
# 28 "src/dune_lang/jbuild_lexer.mll"
    ( token lexbuf )
# 196 "src/dune_lang/jbuild_lexer.ml"

  | 2 ->
# 30 "src/dune_lang/jbuild_lexer.mll"
    ( Token.Lparen )
# 201 "src/dune_lang/jbuild_lexer.ml"

  | 3 ->
# 32 "src/dune_lang/jbuild_lexer.mll"
    ( Rparen )
# 206 "src/dune_lang/jbuild_lexer.ml"

  | 4 ->
# 34 "src/dune_lang/jbuild_lexer.mll"
...
# 216 "src/dune_lang/jbuild_lexer.ml"
...
# 223 "src/dune_lang/jbuild_lexer.ml"

  | 6 ->
# 45 "src/dune_lang/jbuild_lexer.mll"
    ( Sexp_comment )
# 228 "src/dune_lang/jbuild_lexer.ml"

  | 7 ->
# 47 "src/dune_lang/jbuild_lexer.mll"
    ( Eof )
# 233 "src/dune_lang/jbuild_lexer.ml"

  | 8 ->
# 49 "src/dune_lang/jbuild_lexer.mll"
    ( atom "" (Lexing.lexeme_start_p lexbuf) lexbuf )
# 238 "src/dune_lang/jbuild_lexer.ml"
...
and __ocaml_lex_atom_rec acc start lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 53 "src/dune_lang/jbuild_lexer.mll"
    ( lexbuf.lex_start_p <- start;
      error lexbuf "jbuild atoms cannot contain #|"
    )
# 252 "src/dune_lang/jbuild_lexer.ml"
...
# 259 "src/dune_lang/jbuild_lexer.ml"

  | 2 ->
let
# 60 "src/dune_lang/jbuild_lexer.mll"
                                               s
# 265 "src/dune_lang/jbuild_lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 61 "src/dune_lang/jbuild_lexer.mll"
    ( atom (if acc = "" then s else acc ^ s) start lexbuf
    )
# 270 "src/dune_lang/jbuild_lexer.ml"
...
# 280 "src/dune_lang/jbuild_lexer.ml"
...
and __ocaml_lex_quoted_string_rec mode lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 73 "src/dune_lang/jbuild_lexer.mll"
    ( Buffer.contents escaped_buf )
# 292 "src/dune_lang/jbuild_lexer.ml"
...
# 79 "src/dune_lang/jbuild_lexer.mll"
               s
# 306 "src/dune_lang/jbuild_lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 80 "src/dune_lang/jbuild_lexer.mll"
    ( Lexing.new_line lexbuf;
      Buffer.add_string escaped_buf s;
      quoted_string mode lexbuf
    )
# 313 "src/dune_lang/jbuild_lexer.ml"

  | 3 ->
let
# 84 "src/dune_lang/jbuild_lexer.mll"
         c
# 319 "src/dune_lang/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 85 "src/dune_lang/jbuild_lexer.mll"
    ( Buffer.add_char escaped_buf c;
      quoted_string mode lexbuf
    )
# 325 "src/dune_lang/jbuild_lexer.ml"
...
# 333 "src/dune_lang/jbuild_lexer.ml"
...
# 96 "src/dune_lang/jbuild_lexer.mll"
    ( quoted_string mode lexbuf )
# 345 "src/dune_lang/jbuild_lexer.ml"
...
# 360 "src/dune_lang/jbuild_lexer.ml"

  | 1 ->
# 105 "src/dune_lang/jbuild_lexer.mll"
    ( ()
    )
# 366 "src/dune_lang/jbuild_lexer.ml"

  | 2 ->
# 108 "src/dune_lang/jbuild_lexer.mll"
    ( error lexbuf "unterminated block comment"
    )
# 372 "src/dune_lang/jbuild_lexer.ml"

  | 3 ->
# 111 "src/dune_lang/jbuild_lexer.mll"
    ( block_comment lexbuf
    )
# 378 "src/dune_lang/jbuild_lexer.ml"
...
# 118 "src/dune_lang/jbuild_lexer.mll"
                                       c
# 397 "src/dune_lang/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 119 "src/dune_lang/jbuild_lexer.mll"
    ( let c =
        match c with
        | 'n' -> '\n'
        | 'r' -> '\r'
...
# 411 "src/dune_lang/jbuild_lexer.ml"
  ...
  | 2 ->
let
# 130 "src/dune_lang/jbuild_lexer.mll"
              c1
# 417 "src/dune_lang/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos
and
# 130 "src/dune_lang/jbuild_lexer.mll"
                            c2
# 422 "src/dune_lang/jbuild_lexer.ml"
...
# 131 "src/dune_lang/jbuild_lexer.mll"
...
# 437 "src/dune_lang/jbuild_lexer.ml"

  | 3 ->
let
# 138 "src/dune_lang/jbuild_lexer.mll"
              s
# 443 "src/dune_lang/jbuild_lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 139 "src/dune_lang/jbuild_lexer.mll"
...
# 452 "src/dune_lang/jbuild_lexer.ml"
  ...
  | 4 ->
let
# 145 "src/dune_lang/jbuild_lexer.mll"
                     c1
# 458 "src/dune_lang/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1)
and
# 145 "src/dune_lang/jbuild_lexer.mll"
                                      c2
# 463 "src/dune_lang/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 2) in
...
# 470 "src/dune_lang/jbuild_lexer.ml"

  | 5 ->
let
# 150 "src/dune_lang/jbuild_lexer.mll"
                     s
# 476 "src/dune_lang/jbuild_lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 151 "src/dune_lang/jbuild_lexer.mll"
    ( if mode = In_quoted_string then
...
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 158 "src/dune_lang/jbuild_lexer.mll"
    ( Buffer.add_char escaped_buf '\\';
      Buffer.add_char escaped_buf c;
      Other
    )
# 498 "src/dune_lang/jbuild_lexer.ml"
...
# 506 "src/dune_lang/jbuild_lexer.ml"
